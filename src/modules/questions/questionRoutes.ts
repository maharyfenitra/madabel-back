...
export async function questionRoutes(fastify: FastifyInstance) {
  ...
  fastify.get<{ Params: { quizId: string } }>("/quizzes/:quizId/questions", {}, handleFindQuestions);

  fastify.post<{ Params: { quizId: string }; Body: any }>("/quizzes/:quizId/questions", {}, handleCreateQuestion);

  fastify.put<{ Params: { id: string }; Body: any }>("/questions/:id", {}, handleUpdateQuestion);
  fastify.delete<{ Params: { id: string } }>("/questions/:id", {}, handleDeleteQuestion);
}
